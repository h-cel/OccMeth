...
% This files launches the bias correction of the GCM/RCM input.
...
%save('E:\Users\jpvdveld\Onderzoek\Data\0_original\MPI-rcp45_xfs.mat', 'xfs');

%% 4. Specify bias adjustment method

% A combination of different bias adjustment methods can be given. This is
% done via two Boolean vectors, in which each element represents a method

occ_methods = [1 1 1]; %Occurrence
int_methods = [1 0]; %Intensity
