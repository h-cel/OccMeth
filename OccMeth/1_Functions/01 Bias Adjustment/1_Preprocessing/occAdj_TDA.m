...
%   occurrence bias adjustment as proposed by M.T.Pham ('Triangular distribution Adjustment')
%
...
%
%   This frequency correction has several important steps. First, the
...
%
%   Last update by J. Van de Velde on 12/12/'20
...
for m = 1:12 %For each month
    ...
    if fFDF > 1 %Check for unrealistic values of fFDF
        fFDF = 1;
    elseif fFDF < 0
        fFDF = 0;
    end
