function [indices, bias, RB_O, RB_MB] = BA_Evaluation(xfs, xobs, name, save_name, occ_methods, int_methods)
...
%       occ_methods: Boolean vector [1x3] indicating which occurence methods
%       have been used. 1: 'none', 2: 'ssr', 3: 'tda'
%       int_methods: Boolean vector [1x2] indicating which intensity methods
%       have been used. 1: 'qdm', 2: 'mbcn'
%   Outputs:
...
indices(2:end, 1) = {'Q-qnt5'; 'Q-qnt25';'Q-qnt50';'Q-qnt75';'Q-qnt90';'Q-qnt95';'Q-qnt99';'Q-qnt995'; 'Q-val20yr'; 'P-qnt5'; 'P-qnt25';'P-qnt50';'P-qnt75';'P-qnt90';'P-qnt95';'P-qnt99';'P-qnt995'; 'P-trans00'; 'P-trans10'; 'RX1day'; 'RX5day'; 'SDII'; 'R10'; 'R20'; 'ndry'; 'PRCPTOT'; 'E-qnt5'; 'E-qnt25';'E-qnt50';'E-qnt75';'E-qnt90';'E-qnt95';'E-qnt99';'E-qn995'; 'T-qnt5'; 'T-qnt25';'T-qnt50';'T-qnt75';'T-qnt90';'T-qnt95';'T-qnt99';'T-qn995'; 'corrPE'; 'corrPT'; 'corrET'; 'autocorrP1'; 'crosscorrPE0'; 'crosscorrPE1'; 'crosscorrPT0'; 'crosscorrPT1'; 'crosscorrET0'; 'crosscorrET1'};
...
for i = 1:cnt_methods
    ...
    xlabel('Discharge (m^3/s)', 'Interpreter', 'Latex')
    ...
    title('Empirical CDF for precipitation')
    ...
    title('Empirical CDF for precipitation larger than 95th quantile')
    xlabel('Precipitation (mm)')
    ylabel('Cumulative probability')
    hold on
    ...
    title('Empirical CDF of evaporation')
    xlabel('Evaporation (mm)')
    ylabel('Cumulative probability')
    hold on
    ...
    title('Empirical CDF for temperature')
...
lgnd1 = [name_figs, 'Original RCM simulations', 'Observations'];
lgndbar = ['Original RCM simulations', name_figs];
lgndbox = ['Observations', 'Original RCM simulations',  name_figs];
...
xlabel('Precipitation (mm)')
ylabel('Probability density')
title('PDF of precipitation > 95th quantile')
legend(lgnd1, 'FontSize', 30)
set(gca,'FontSize',30)
set(gca,'FontName', 'UGent Panno Text')
fullfig(f9)
...
xlabel('Evaporation (mm)')
ylabel('Probability density')
title('PDF of evapotranspiration')
legend(lgnd1, 'FontSize', 30)
set(gca,'FontSize',30)
set(gca,'FontName', 'UGent Panno Text')
fullfig(f10)
...
xlabel('Discharge (m^3/s)', 'Interpreter', 'Latex')
ylabel('Probability density')
title('PDF of discharge > 95th quantile')
legend(lgnd1, 'FontSize', 30)
set(gca,'FontSize',30)
set(gca,'FontName', 'UGent Panno Text')
fullfig(f17)
...
xlabel('Methods')
title('Box plots of monthly 1-day maximum precipitation amounts for each BC method')
set(gca,'FontSize',30)
set(gca,'FontName', 'UGent Panno Text')
fullfig(f12)
...
ylabel('Precipitation (mm)')
xlabel('Methods')
title('Box plots of monthly consecutive 5-day maximum precipitation amounts for each BC method')
set(gca,'FontSize',30)
set(gca,'FontName', 'UGent Panno Text')
fullfig(f13)
...
ylabel('Intensity index (mm/day)')
xlabel('Methods')
title('Box plots of yearly SDII indices for each BC method')
set(gca,'FontSize',30)
set(gca,'FontName', 'UGent Panno Text')
fullfig(f14)
...
xlabel('Methods')
title('Box plots of annual precipitation for each BC method')
set(gca,'FontSize',30)
set(gca,'FontName', 'UGent Panno Text')
fullfig(f15)
...
xlabel('Methods')
title('Box plots of annual number of heavy precipitation days')
set(gca,'FontSize',30)
set(gca,'FontName', 'UGent Panno Text')
fullfig(f18)
...
ylabel('Number of days')
xlabel('Methods')
title('Box plots of annual number of very heavy precipitation days')
set(gca,'FontSize',30)
set(gca,'FontName', 'UGent Panno Text')
fullfig(f19)
...
bar(x, barQ)
xlabel('Days')
ylabel('Discharge (m^3/s)', 'Interpreter', 'Latex')
